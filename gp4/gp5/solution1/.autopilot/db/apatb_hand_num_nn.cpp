...
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.hand_num_nn.autotvout_input_r.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.hand_num_nn.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.hand_num_nn.autotvout_ap_return.dat"
...
extern "C"
float hand_num_nn_hw_stub_wrapper(void*);

extern "C"
float apatb_hand_num_nn_hw(void* __xlx_apatb_param_input_r)
{
  float ap_return;
  ...
  port1.param = { __xlx_apatb_param_input_r };
  port1.depth = { 5 };
  port1.offset = {  };
  ...
  try {
    ...
    ap_return = hand_num_nn_hw_stub_wrapper(__xlx_apatb_param_input_r);
