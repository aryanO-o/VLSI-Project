...
using hls::sim::Byte;
extern "C" float hand_num_nn(Byte<4>*);
extern "C" float apatb_hand_num_nn_hw(volatile void * __xlx_apatb_param_input_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 5;
  int __xlx_offset_param_input_r = 0;
  int __xlx_offset_byte_param_input_r = 0*4;
  // DUT call
  float ap_return = hand_num_nn(__xlx_input_r__tmp_vec.data());
