...
if {[file isfile hand_num_nn.autotvin.dat]} {
	file delete -force hand_num_nn.autotvin.dat
}

if {[file isfile hand_num_nn.autotvout.dat]} {
	file delete -force hand_num_nn.autotvout.dat
}
