...
`define AUTOTB_DUT      hand_num_nn
`define AUTOTB_DUT_INST AESL_inst_hand_num_nn
`define AUTOTB_TOP      apatb_hand_num_nn_top
`define AUTOTB_LAT_RESULT_FILE "hand_num_nn.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hand_num_nn.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hand_num_nn_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_MEM_input_r AESL_automem_input_r
`define AESL_MEM_INST_input_r mem_inst_input_r
`define AUTOTB_TVIN_input_r  "../tv/cdatafile/c.hand_num_nn.autotvin_input_r.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.hand_num_nn.autotvin_input_r.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.hand_num_nn.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.hand_num_nn.autotvout_ap_return.dat"
module `AUTOTB_TOP;
