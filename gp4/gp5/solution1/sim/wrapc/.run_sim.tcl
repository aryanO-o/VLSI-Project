...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hand_num_nn.autotvin.dat"
	set constFileTvOut       "hand_num_nn.autotvout.dat"
	set constFileHdlTvIn     "hand_num_nn.autohdltvin.dat"
	set constFileHdlTvOut    "hand_num_nn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
